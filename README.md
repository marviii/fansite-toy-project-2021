...
Abrindo este projeto no VSCode, algumas extensões serão sugeridas para instalação. Elas permitem uma melhor edição de códigos HTML, CSS e JavaScript, então considere instalar todas.
...
Use a extensão `live-server` do Visual Studio Code para levantar um Servidor HTTP abrindo o arquivo [index.html](index.html) e executando o comando (`CTRL + SHIFT + P`) _Open with Live Server_.
